...
export const meta = () => metaCreator('Nightmares Explained | Guides', 'Nightmares Explained | Guides desc', bgImage);

function SnakeDreams() {
        ...
        <Container>
          <Grid container item xs={12} lg={7} justifyContent="center" flexDirection="column">
            ...
            <MKTypography
              ...
              pr={{ xs: 0, sm: 6 }}
            >
              A key symbol from modern and ancient cultures
            </MKTypography>
          </Grid>
        </Container>
      </MKBox>
