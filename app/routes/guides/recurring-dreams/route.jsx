...
export const meta = () => metaCreator('Recurring Dreams | Guides', 'Recurring Dreams | Guides desc', bgImage);

function RecurringDreams() {
  const headerRef = useRef(null);
  // // document.title = "Recurring Dreams | Guides | UYD";
...
export default RecurringDreams;
